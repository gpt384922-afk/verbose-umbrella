...
class Settings(BaseSettings):
    ...
    hunt_organization_rotation_enabled: bool = Field(default=False, alias="HUNT_ORGANIZATION_ROTATION_ENABLED")
    hunt_organization_rotation_cloud_miss_count: int = Field(
        default=5,
